...
import {
  FleetSupportIssueType,
  FleetSupportPriority,
} from "@/interface/FleetInterface";
import { useCreateFleetSupportMutation } from "@/redux/features/support/fleetSupportApi";
import {
  BookOpen,
  Calendar,
  Car,
...
export default function SupportPage() {
  const [createSupportRequestFn, { isLoading: isSubmitting }] =
    ...
    <div className="p-4 lg:p-8 space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Get help with your fleet services and account
        </p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-blue-600">(561) 232-3230</p>
            ...
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-red-600">(561) 232-3230</p>
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Upload CSV files related to your issue
                </p>
